...
export const callToAction =
  "https://www.linkedin.com/in/abhishek-tripathi-843b11217/";
...
export const educationList = [
  {
    ...
    content1: "Major: Computer Science with CGPA 9.15",
...
export const achievements = [
  {
    id: "a-1",
    icon: achivement,
    event: "Best Performer of 2022-23",
    position: "Winner",
    content1: "Best Performance in Web Development",
    content2: "Best Performance in PHP Development",
    content3: "",
    article:
      "",
    project: "",
...
export const experiences = [
  ...
  {
    organisation: "The Adroit",
    logo: adroit,
    link: "https://www.theadroit.in/",
    positions: [
      {
        title: "Full Stack Developer",
...
export const socialMedia = [
  {
    id: "social-media-1",
    icon: AiFillLinkedin,
    link: "https://www.linkedin.com/in/abhishek-tripathi-843b11217",
  },
  {
    id: "social-media-2",
    icon: AiFillGithub,
    link: "https://github.com/AbhisehkTripathi/",
  },
  {
    id: "social-media-3",
    icon: AiFillMail,
    link: "abhishektripathi2096a@gmail.com",
  },
];
